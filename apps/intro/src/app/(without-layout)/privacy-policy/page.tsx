  ...
  return (
    <>
      <header className="fixed top-0 left-0 z-10 flex w-full flex-row items-center bg-white px-4 py-2.5 shadow-sm">
        ...
        <h1 className="font-body1-normal-bold text-label-neutral ml-2">개인정보 처리방침</h1>
      </header>
      <main className="flex flex-col px-4 py-6 pt-16">
        <section aria-labelledby="privacy-policy-title">
          <h2 id="privacy-policy-title" className="font-body1-normal-bold mb-2">
            경매톡 개인정보 처리방침
          </h2>
          <ul
        ...
        <section aria-labelledby="privacy-purpose">
          ...
          <div className="font-label1-normal-regular text-label-neutral space-y-2 break-keep">
            <p>
              &lt;데벨&gt;(&apos;www.gyeongmaetalk.shop&apos; 이하 &apos;경매톡&apos;)은(는)
              개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적 이외의
              용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전 동의를 구할 예정입니다.
            </p>
            ...
            <dl className="mt-4 space-y-4">
              <div>
                ...
                <dd>
                  회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원 자격
                  유지·관리, 서비스 부정이용 방지, 각종 고지·통지, 고충처리, 분쟁 조정을 위한 기록
              ...
              <div>
                ...
                <dd>
                  경매지도사와의 매칭, 경매 물건 대행 의뢰 시스템 운영, 선입금 및 유료 결제 정산,
                  경매 관련 정보 및 콘텐츠 제공, 맞춤 서비스 제공 등을 목적으로 개인정보를
                  처리합니다.
                </dd>
              </div>
              ...
              <div>
                ...
                <dd>
                  신규 서비스 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 제공 및 참여 기회
                  제공, 인구통계학적 특성에 따른 서비스 제공 및 광고 게재, 서비스의 유효성 확인,
                  접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계 등을 목적으로 개인정보를
                  처리합니다.
                </dd>
              </div>
            </dl>
            ...
            <div>
              ...
              <dl className="space-y-1">
                <div className="flex gap-2">
                  <dt className="font-label1-normal-bold min-w-[100px]">개인정보 항목</dt>
                  <dd>
                    서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록, 방문 일시, 단말기
                    정보 등
                  </dd>
                </div>
                <div className="flex gap-2">
        ...
        <section aria-labelledby="privacy-third-party">
          ...
          <div className="font-label1-normal-regular text-label-neutral space-y-3 break-keep">
            <p>
              ...
              「개인정보보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게
              제공합니다.
            </p>
            <p>
        ...
        <section aria-labelledby="privacy-rights">
          ...
          >
            ...
            <li>
              ...
              서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 데벨은(는) 이에 대해 지체
              없이 조치하겠습니다.
            </li>
            <li>
            ...
            <li>
              ⑥ 데벨은 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람
        ...
        <section aria-labelledby="privacy-items">
          ...
          <div className="font-label1-normal-regular text-label-neutral space-y-3 break-keep">
            <p>
              ① &lt;데벨&gt;(&apos;경매톡&rsquo;)은(는) 다음과 같이 개인정보 항목을 처리하고
              있습니다.
            </p>

            <ul className="ml-4 list-inside list-disc space-y-2" role="list">
              <li>
                개인 식별 정보: 이메일, 휴대전화번호, 이름, 로그인ID, 비밀번호, 성별, 생년월일
              </li>
              <li>
        ...
        <section aria-labelledby="privacy-destruction">
          ...
          <div className="font-label1-normal-regular text-label-neutral space-y-3 break-keep">
            <p>
              &lt;데벨&gt;(&apos;경매톡&rsquo;)은(는) 원칙적으로 개인정보 처리 목적이 달성된
              경우에는 지체 없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과
              같습니다.
            </p>
            ...
            <ul className="list-inside list-disc space-y-3">
              <li>
                ...
                목적 달성 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타 관련
                법령에 따라 일정 기간 저장된 후 혹은 즉시 파기됩니다. 이 때, DB로 옮겨진 개인정보는
        ...
        <section aria-labelledby="privacy-officer">
          ...
          <div className="font-label1-normal-regular text-label-neutral space-y-3 break-keep">
            ...
            <p className="mt-3">
              ...
              모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자
              및 담당부서로 문의하실 수 있습니다. 데벨(&apos;경매톡&rsquo;)은(는) 정보주체의 문의에
          ...
          <div className="font-label1-normal-regular text-label-neutral space-y-3 break-keep">
            ...
            <ol className="list-inside list-decimal space-y-3" role="list">
              ...
              <li>
                ...
                <p className="mt-1 ml-4">
                  &lt;데벨&gt;(&apos;경매톡&rsquo;)은(는) 해킹이나 컴퓨터 바이러스 등에 의한
                  개인정보 유출 및 훼손을 막기 위하여 보안 프로그램을 설치하고 주기적인 갱신·점검을
                  하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및
                  차단하고 있습니다.
                </p>
              </li>
              <li>
                ...
                <p className="mt-1 ml-4">
                  개인정보를 처리하는 데이터베이스 시스템에 대한 접근 권한의 부여, 변경, 말소를
                  통하여 개인정보에 대한 접근 통제를 위해 필요한 조치를 하고 있으며,
