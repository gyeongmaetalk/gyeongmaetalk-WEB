...
export default function TermsOfServicePage() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 z-10 flex w-full flex-row items-center bg-white px-4 py-2.5 shadow-sm">
        <button
          onClick={() => router.back()}
          className="hover:bg-cool-neutral-99 flex items-center justify-center rounded-md p-1 transition-colors"
          aria-label="뒤로가기"
        >
          <ChevronLeft className="text-label-neutral h-6 w-6" />
        </button>
        <h1 className="font-body1-normal-bold text-label-neutral ml-2">이용약관</h1>
      </header>
      <main className="flex flex-col px-4 py-6 pt-16">
        <section>
          <h2 className="font-body1-normal-bold mb-2">제 1조 (목적)</h2>
          ...
          <div className="bg-cool-neutral-95 my-4 h-px w-full" />
        </section>
        <section>
          <h2 className="font-body1-normal-bold mb-2">제 2조 (용어의 정의)</h2>
          <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
            <li>
              ...
              <ol className="ml-4 list-inside list-[lower-alpha] space-y-2 break-keep">
                ...
                <li>
                  &apos;서비스&lsquo;란 회사가 모바일 어플리케이션 등을 통해 제공하는 부동산
                  경매정보, 경매지도사 매칭, 경매 물건 대행 의뢰 등 경매 관련 제반 서비스를
                  의미합니다.
                </li>
                <li>
                ...
                <li>
                  &apos;경매지도사&lsquo;란 회사와의 계약을 통해 회원에게 경매 컨설팅 및 대행
                  서비스를 제공하는 전문가를 의미합니다.
                </li>
                <li>
        ...
        <h2 className="font-body1-normal-bold mb-2">제 3조 (이용계약의 체결 및 적용)</h2>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
            회원이 되고자 하는 이용자는 회사와 서비스 이용계약을 체결하여야 합니다. 서비스
            이용계약은 이용자가 본 약관에 동의하고 이용신청을 하면, 회사가 이를 승낙함으로써
            성립됩니다.
          </li>
          <li>
        ...
        <h2 className="font-body1-normal-bold mb-2">제 4조 (서비스 내용 및 정보 제공)</h2>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
        ...
        <h2 className="font-body1-normal-bold mb-2">제 5조 (경매 물건 대행 의뢰 및 유료 서비스)</h2>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
          ...
          <li>
            선입금은 경매지도사 매칭 및 초기 컨설팅 비용의 성격을 가지며, 회사가 경매 지도사에게
            대행 수수료를 지급하는 데 사용됩니다.
          </li>
          <li>
        ...
        <div className="bg-cool-neutral-95 my-4 h-px w-full" />
        <h2 className="font-body1-normal-bold mb-2">제 6조 (리뷰 작성 및 관리)</h2>

        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
            회원은 첫 무료 상담(경매 컨설팅) 이후 경매지도사에 대한 리뷰를 작성할 수 있습니다.
          </li>
          <li>
        ...
        <h2 className="font-body1-normal-bold mb-2">제 7조 (회원 정보 및 통지)</h2>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          ...
          <li>
            회사는 관련 법령이 정하는 바에 따라 회원의 개인정보를 보호하며, 개인정보의 보호 및
            사용에 대해서는 회사의 개인정보처리방침에 따릅니다.
          </li>
        </ol>
        <div className="bg-cool-neutral-95 my-4 h-px w-full" />

        <h2 className="font-body1-normal-bold mb-2">제 8조 (회사의 의무)</h2>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
            회사는 본 약관 및 관계 법령을 준수하고, 안정적인 서비스를 제공하기 위해 노력합니다.
          </li>
          <li>
        ...
        <h2 className="font-body1-normal-bold mb-2">제 9조 (회원의 의무)</h2>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
        ...
        <h2 className="font-body1-normal-bold mb-2">제 10조 (손해배상)</h2>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
        ...
        <h2 className="font-body1-normal-bold mb-2">제 11조 (회사의 면책)</h2>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
          ...
          <li>
            회사는 회원의 고의 또는 과실로 인한 서비스 이용의 장애에 대해 책임을 지지 않습니다.
          </li>
          <li>
            회사는 무료로 제공되는 서비스와 관련하여 발생하는 손해에 대해 책임을 지지 않습니다.
          </li>
        </ol>
        <div className="bg-cool-neutral-95 my-4 h-px w-full" />

        <h2 className="font-body1-normal-bold mb-2">제 12조 (분쟁 해결)</h2>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
        ...
        <h2 className="font-body1-normal-bold mb-2">제 13조 (청약철회 및 서비스 이용료의 환불)</h2>
        ...
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
            ...
            <ol className="mt-1 ml-4 list-inside list-[lower-alpha] space-y-1 break-keep">
              <li>
                청약철회 기간: 회원은 &apos;경매지도사 매칭 서비스&apos;를 결제한 날로부터 14일
                이내에 회사에 청약철회(환불)를 요청할 수 있습니다.
              </li>
              <li>
                환불 제한 조건: 위 1항의 기간 이내라 하더라도, 다음 각 호의 어느 하나에 해당하는
                경우 청약철회가 제한될 수 있습니다.
              ...
              <li>
                환불 금액: 청약철회 조건 충족 시 회사는 회원이 결제한 대금 전액을 환불합니다. 단,
                이미 서비스가 일부 이행된 경우 회사는 일정 비율의 위약금을 공제할 수 있습니다.
              </li>
            </ol>
          </li>
          <li>
            ...
            <ol className="mt-1 ml-4 list-inside list-[lower-alpha] space-y-1 break-keep">
              <li>
                청약철회 제한: 본 서비스는 결제와 동시에 디지털 콘텐츠(매물 상세 정보) 제공이
                개시되는 서비스입니다. 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항에
                의거하여, 상세 내용을 확인하기 위해 결제를 완료한 건에 대해서는 청약철회 및 환불이
                엄격히 제한됩니다.
              </li>
            </ol>
          </li>
