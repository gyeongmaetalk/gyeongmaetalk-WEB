  ...
  return (
    <>
      ...
      <main className="flex flex-col px-4 py-6 pt-16">
        ...
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
            회원은 경매지도사를 통한 경매 물건 대행 의뢰 및 매칭 서비스를 이용하기 위해 회사가
            안내한 법인 명의의 계좌로 300,000원(VAT 포함)의 선입금을 납부해야 합니다.
          </li>
          <li>
          ...
          <li>
            회원이 경매지도사로부터 추천받은 매물에 대한 상세 내역 열람 서비스는 건당 30,000원의
            유료 서비스이며, 해당 금액은 회사가 안내한 법인 계좌로 입금하는 방식으로 납부합니다.
          </li>
          <li>
        ...
        <div className="font-label1-normal-regular text-label-neutral mb-4 break-keep">
          본 조항은 「전자상거래 등에서의 소비자보호에 관한 법률」 등 관계 법령에 따라 회사가
          제공하는 유료 서비스의 청약철회 및 환불 기준을 규정합니다.
        </div>
        <ol className="font-label1-normal-regular text-label-neutral list-inside list-decimal space-y-2 break-keep">
          <li>
            기본 매칭 서비스 (300,000원)
          ...
          <li>
            ...
            <ol className="mt-1 ml-4 list-inside list-[lower-alpha] space-y-1 break-keep">
              <li>
                회원은 앱 또는 서비스 내 [1:1 문의] 기능을 통해 환불을 요청해야 하며, 환불 요청은
                접수 시점을 기준으로 처리됩니다.
              </li>
              <li>
              ...
              <li>
                이미 제공된 서비스의 범위에 따라 합리적인 위약금, 금융기관 송금 수수료 등이 공제될
                수 있습니다.
              </li>
            </ol>
          </li>
